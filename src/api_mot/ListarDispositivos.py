...
def execute_web(base_url, access_token, client_id, page, lines_per_page, show_contracted):
    endpoint = f"{base_url}broker/devices"
...
def execute(base_url, access_token, client_id, page, lines_per_page, show_contracted):
    response, _ = execute_web(base_url, access_token, client_id, page, lines_per_page, show_contracted)
